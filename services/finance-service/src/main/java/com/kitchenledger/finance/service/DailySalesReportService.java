...
public class DailySalesReportService {
    ...
    public DailySalesReport create(UUID tenantId, UUID createdBy, CreateDsrRequest req) {
        ...
        DailySalesReport dsr = DailySalesReport.builder()
                ...
                .giftCardSales(req.getGiftCardSales())
                .walletSales(req.getWalletSales())
                .compsTotal(req.getCompsTotal())
                .voidsTotal(req.getVoidsTotal())
                .tipsCollected(req.getTipsCollected())
                .managerAuthId(req.getManagerAuthId())

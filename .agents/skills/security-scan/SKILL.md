---
name: security-scan
description: Scans only `.Codex/` config files (AGENTS.md, settings.json, MCP servers, hooks, agents) for security risks via AgentShield. NOT for application code — use `/security-audit` for app security, `/security-review` for inline dev patterns.
origin: ECC
---
